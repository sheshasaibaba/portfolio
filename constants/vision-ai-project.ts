...
export const visionAIProject: Project = {
  ...
  technicalHighlight:
    "Ensemble CV + Flask API for cosine NN retrieval with demographic-aware search pruning.",
  description:
  ...
  details:
    "Flask REST API, ONNX runtime, cosine NN retrieval with demographic pruning for sub-2s end-to-end.",
  narrative: {
    mission:
    ...
    technicalDeepDive: [
      ...
      "Deployment: Flask REST API for raw image upload, GPU ONNX inference, Base64-encoded recommendation payloads for frontend integration.",
    ],
  },
};
